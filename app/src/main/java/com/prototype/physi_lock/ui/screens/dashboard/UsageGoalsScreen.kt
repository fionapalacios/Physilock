    ...
    Column(
        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    .background(
                        if (isOver) AccentLavender.copy(alpha = 0.20f) else PrimaryGreen.copy(alpha = 0.20f),
                ...
                Text(
                    ...
                    fontWeight = FontWeight.Medium,
                    lineHeight = 18.sp,
                    color = if (isOver) AccentLavender else PrimaryGreen
                )
            }
        }
        ...
        Box(
            ...
            Box(
                modifier = Modifier
                    ...
                    .fillMaxHeight()
                    .background(if (isOver) AccentLavender else PrimaryGreen, RoundedCornerShape(50))
            )
        }
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(5.63.dp)) {
                listOf(28f, 35f, 42f).forEach { preset ->
                    ...
                    Box(
                        modifier = Modifier
                            .background(
                                if (active) PrimaryGreen else Color.White.copy(alpha = 0.10f),
    ...
    Column(
        ...
        Row(
            ...
            if (isOver) {
                Box(
                    modifier = Modifier
                        .background(AccentLavender.copy(alpha = 0.13f), RoundedCornerShape(50))
        ...
        Slider(
            ...
            colors = SliderDefaults.colors(
                ...
                activeTrackColor = AccentLavender.copy(alpha = 0.4f),
                ...
                item.presets.forEach { preset ->
                    ...
                    Box(
                        ...
                        Text(
                            ...
                            fontWeight = FontWeight.Medium,
                            lineHeight = 18.sp,
                            color = if (active) BackgroundLight else DeepOlive
                        )
                    }
                }
            }
...
private fun AiRecommendationCard() {
    Row(
        ...
        Column {
            ...
            Text(
                text = "Based on your usage pattern, reducing social media by 30 min/day could " +
                    "lower your addiction risk score from 62 to ~45 in 2 weeks.",
                fontFamily = NunitoFontFamily,
                fontSize = 13.sp,
                fontWeight = FontWeight.Normal,
                lineHeight = 19.5.sp,
...
@Composable
private fun UsageGoalsScreenPreview() {
    PhysiLockTheme {
        UsageGoalsScreen(onBackClick = {}, onSaveClick = {})
    }
}
